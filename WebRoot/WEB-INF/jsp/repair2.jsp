...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="<%=basePath%>repair2"><strong>高校寝室管理系统</strong></a>
	</div>
	    <!-- 用户状态 -->
		<br class="dropdown">
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
				    <a href="${pageContext.request.contextPath}/repair2" class="active">
	...
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="post" 
				      action="${pageContext.request.contextPath}/repair2">
					<div class="form-group">
						<label for="roomid">寝室编号</label> 
		...
		<a href="#" class="btn btn-primary" data-toggle="modal" 
		           data-target="#newRepairDialog" onclick="clearRepair()">新增</a>
		           <br></br>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<tbody>
							<c:forEach items="${page.rows}" var="row">
								<tr>
									...
									<td>${row.date}</td>
									<td>
						<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#repairEditDialog"
										 onclick= "editRepair(${row.roomid})">修改</a>
						<a href="#" class="btn btn-danger btn-xs" data-toggle="modal" onclick="deleteRepair(${row.roomid})">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
					...
					<div class="col-md-12 text-right">
						<itheima:page url="${pageContext.request.contextPath}/repair2" />
					</div>
					<!-- /.panel-body --> 
				</div>
				<!-- /.panel ->
